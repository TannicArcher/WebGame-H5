...
var Main = function (t) {
	...
	e.prototype.onAddToStage = function (t) {
		...
		DeviceUtils.IsPC && (StageUtils.ins().setScaleMode(egret.StageScaleMode.SHOW_ALL), StageUtils.ins().getStage().orientation = egret.OrientationMode.AUTO),
		-1 != navigator.userAgent.indexOf("iPad") && (StageUtils.ins().getStage().orientation = egret.OrientationMode.AUTO),
	...
	e.prototype.loadResVersionComplete = function () {
	...
	e.prototype.onConfigComplete = function () {
		...
		var t = new eui.Theme(RES_RESOURCE + "default.thm.json", this.stage);
